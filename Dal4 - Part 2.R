...
Answer1 <- "The vizualization appears to provide evidence against H0 as the percentages are not exactly the same" 
...
Answer2 <- "The visualization provides evidence against H0 as the percentages are not the same."
